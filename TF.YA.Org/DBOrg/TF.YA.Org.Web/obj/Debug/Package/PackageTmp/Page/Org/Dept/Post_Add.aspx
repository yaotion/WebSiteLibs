<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Post_Add.aspx.cs" Inherits="TF.YA.Org.Web.Org.Post_Add" %>
        ...
        <div style="padding: 20px; clear: both;">
            <div style="clear: both; padding-top: 5px">
                ...
                <div style="float: left;">                    
                    <input id='TB_PostID' runat="server" style='width: 200px; height: 13px;' type='text'
                        value='' />
                </div>
            </div>
            <div style="clear: both; padding-top: 5px">
                ...
                <div style="float: left;">
                    <input id='TB_PostName' runat="server" style='width: 200px; height: 13px;' type='text'
                        value='' />
                </div>
            </div>
