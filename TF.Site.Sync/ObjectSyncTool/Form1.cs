...
namespace ObjectSyncTool
{
    ...
    {
        string strSourceConn = "Data Source=192.168.1.201;Initial Catalog=BSYA_WebSite;User ID=sa;PassWord=Think123;";
        string strStoreConn = "Data Source=192.168.1.201;Initial Catalog=BSYA_WebSite;User ID=sa;PassWord=Think123;";
