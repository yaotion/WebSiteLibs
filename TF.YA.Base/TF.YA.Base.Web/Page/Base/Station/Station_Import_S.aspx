<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Station_Import_S.aspx.cs" Inherits="TF.YA.Base.Web.Page.Base.Station.Station_Import_S" %>
        ...
        function uploadFile() {
            {
                ...
                $.ajax({
                    url: "/Page/Base/Station/ashx/Station_Import_S.ashx",
                    type: "POST",
                    data: data,
                    contentType: false,
                    processData: false,
