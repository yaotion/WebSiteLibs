<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DutyPlace_Add.aspx.cs" Inherits="TF.YA.Base.Web.Base.DutyPlace.DutyPlace_Add" %>
        ...
        <div style="padding: 20px; clear: both;">
            <div style="clear: both; padding-top: 5px">
                ...
                <div style="float: left;">                    
                    <input id='TB_PlaceID' runat="server" style='width: 200px; height: 13px;' type='text'
                        value='' />
                </div>
                <div style="float: left; width: 80px; text-align: right; padding-right: 5px;">
                    地点名称:
                ...
                <div style="float: left;">                    
                    <input id='TB_PlaceName' runat="server" style='width: 200px; height: 13px;' type='text'
                        value='' />
                </div>
            </div>
